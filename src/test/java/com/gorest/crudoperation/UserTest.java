...
import com.gorest.tetsbase.TestBase;
...
public class UserTest extends TestBase {
    static String name = TestUtils.getRandomValue() + "Mehul";
    static String email = TestUtils.getRandomValue() + "mehul123@gmail.com";
    ...
    public void test04_UpdateUser() {
        name = "Rama" + TestUtils.getRandomValue();
        email ="rama123@gmail.com" + TestUtils.getRandomValue();
